...
# Normalize by the number of selected events (probability density)
counts1 = counts1_raw / counts1_raw.sum() / bin_width
counts2 = counts2_raw / counts2_raw.sum() / bin_width
# ...existing code...
